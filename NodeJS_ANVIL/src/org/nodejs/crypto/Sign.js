 ...
 */
vjo.ctype('org.nodejs.crypto.Sign') //< public
//< needs(org.nodejs.buffer.Buffer)
.inherits('org.nodejs.stream.Writable')
.protos({
	/**
	 * Updates the signer object with data. This can be called many times with new data as 
	 * it is streamed.
	 */
	//> public Sign update({String | Buffer})
	 ...
	 */
	//> public {String | Buffer} sign(String private_key, String? output_format)
	sign: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public Sign ^addListener(String type, Function listener)
	 ...
	 * </pre>
	 */
	//> public Sign ^on(String type, Function listener)
	on: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public Sign ^once(String event, Function listener)
	once: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public Sign removeListener(String type, Function listener)
	 ...
	 */
	//> public Sign removeAllListeners(String? event)
