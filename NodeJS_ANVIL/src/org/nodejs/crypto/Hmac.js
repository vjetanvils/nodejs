 ...
 */
vjo.ctype('org.nodejs.crypto.Hmac') //< public
//< needs(org.nodejs.buffer.Buffer)
.inherits('org.nodejs.stream.Transform')
.protos({
	/**
	 * Update the hmac content with the given data. This can be called many times with new 
	 * data as it is streamed.
	 */
	//> public Hmac update({Buffer | String} data, String? input_encoding)
	update: vjo.NEEDS_IMPL,
	
	/**
	 * Calculates the digest of all of the passed data to the hmac. The encoding can be 
	 ...
	 * </pre>
	 */
	//> public Hmac ^addListener(String type, Function listener)
	 ...
	 * </pre>
	 */
	//> public Hmac ^on(String type, Function listener)
	on: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public Hmac ^once(String event, Function listener)
	once: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public Hmac removeListener(String type, Function listener)
	 ...
	 */
	//> public Hmac removeAllListeners(String? event)
