 ...
 *******************************************************************************/
/**
 * The class is for creating hash digests of data.
 * <p>
 * Returned by crypto.createHash.
 */
vjo.ctype('org.nodejs.crypto.Hash') //< public
...
.protos({
	 ...
	 * input_encoding and can be 'utf8', 'ascii' or 'binary'. Defaults to 'binary'. This 
	 * can be called many times with new data as it is streamed.
	 */
	//> public Hash update({Buffer | String} data, String? input_encoding)
	update: vjo.NEEDS_IMPL,
	
	/**
	 * Calculates the digest of all of the passed data to be hashed. The encoding can be 
	 * 'hex', 'binary' or 'base64'. Defaults to 'binary'.
	 * <p>
	 * Note: hash object can not be used after digest() method been called.
	 */
	//> public {String | Buffer} digest(String? encoding)
	 ...
	 * </pre>
	 */
	//> public Hash ^addListener(String type, Function listener)
	 ...
	 * </pre>
	 */
	//> public Hash ^on(String type, Function listener)
	on: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public Hash ^once(String event, Function listener)
	once: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public Hash removeListener(String type, Function listener)
	 ...
	 */
	//> public Hash removeAllListeners(String? event)
