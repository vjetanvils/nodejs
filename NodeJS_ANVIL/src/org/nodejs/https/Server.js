 ...
 */
vjo.ctype('org.nodejs.https.Server') //< public
.inherits('org.nodejs.tls.Server')
.protos({	
	// All necessary methods are inherited at this point
	 ...
	 * </pre>
	 */
	//> public org.nodejs.https.Server ^addListener(String type, Function listener)
	 ...
	 * </pre>
	 */
	//> public org.nodejs.https.Server ^on(String type, Function listener)
	on: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public org.nodejs.https.Server ^once(String event, Function listener)
	once: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public org.nodejs.https.Server removeListener(String type, Function listener)
	 ...
	 */
	//> public org.nodejs.https.Server removeAllListeners(String? event)
