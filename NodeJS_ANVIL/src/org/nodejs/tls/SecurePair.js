 ...
 */
vjo.ctype('org.nodejs.tls.SecurePair') //< public
...
.props({
	event: vjo.otype().defs({
		 ...
		 */
		secure: vjo.NEEDS_IMPL //< public void secure()
	}).endType()
})
.protos({
	//------------------------------------------------------------------------------------
	 ...
	 * </pre>
	 */
	//> public SecurePair ^addListener(String type, Function listener)
	 ...
	 * </pre>
	 */
	//> public SecurePair ^on(String type, Function listener)
	on: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public SecurePair ^once(String event, Function listener)
	once: vjo.NEEDS_IMPL,
	 ...
	 * </pre>
	 */
	//> public SecurePair removeListener(String type, Function listener)
	 ...
	 */
	//> public SecurePair removeAllListeners(String? event)
